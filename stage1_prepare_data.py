...
def main_prepareData(info):
    ...
    iterationResultPath = f"results/{material}/{CPLaw}/{CPLaw}{curveIndex}_{optimizerName}"
    ...
    np.save(f'{iterationResultPath}/common/combined_loadings_trueCurves.npy', combined_loadings_trueCurves)
    np.save(f'{iterationResultPath}/common/combined_loadings_processCurves.npy', combined_loadings_processCurves)
    np.save(f'{iterationResultPath}/common/combined_loadings_interpolateCurves.npy', combined_loadings_interpolateCurves)
    np.save(f'{iterationResultPath}/common/reverse_combined_loadings_trueCurves.npy', reverse_combined_loadings_trueCurves)
    np.save(f'{iterationResultPath}/common/reverse_combined_loadings_processCurves.npy', reverse_combined_loadings_processCurves)
    np.save(f'{iterationResultPath}/common/reverse_combined_loadings_interpolateCurves.npy', reverse_combined_loadings_interpolateCurves)
