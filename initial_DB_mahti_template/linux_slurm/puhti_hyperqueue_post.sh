...
hq submit --cpus $DAMASK_NUM_TRHEADS --each-line linux_slurm/hyperqueue_file.txt linux_slurm/puhti_task_post.sh
# Array version
# hq submit --cpus $DAMASK_NUM_TRHEADS --array=1-100 damask.sh
