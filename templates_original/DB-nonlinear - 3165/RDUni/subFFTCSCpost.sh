...
cd /scratch/project_2001353/Rongfei/DBNon/1/RDUni
ulimit -s unlimited 
...
postResults.py --cr f,p --time RVE_1_40_D_tensionX.spectralOut
cd /scratch/project_2001353/Rongfei/DBNon/1/RDUni/postProc
