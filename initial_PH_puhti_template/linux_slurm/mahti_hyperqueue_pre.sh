...
hq submit --cpus $DAMASK_NUM_THREADS --each-line linux_slurm/hyperqueue_file.txt linux_slurm/mahti_task_pre.sh
# Array version
# hq submit --cpus $DAMASK_NUM_THREADS --array=1-100 mahti_task_pre.sh
